...
${html || "<p>No products added yet ❤️</p>"}

`;



document.querySelector(".close-wishlist").onclick=()=>{
...
document.querySelector(".wishlist-panel").classList.add("active");
